...
//
//    @Pointcut("execution(public * com.ydc.cgj.rental.company.app.controller.*.*(..))")
//    public void webLog(){}
//
//    @Before("webLog()")
...
//            companyMap.put("companyId",rentalCompanyCustomerVO.getId());
//            companyMap.put("companyName",rentalCompanyCustomerVO.getRegisteredCompanyName());
//            mongoLogMessageVO.setSubject(companyMap);
//        }
