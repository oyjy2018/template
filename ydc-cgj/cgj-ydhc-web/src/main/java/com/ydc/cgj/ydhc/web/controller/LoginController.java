...
import com.ydc.cgj.ydhc.web.constant.Constants;
...
public class LoginController {
    ...
    public String getLoginParam(Map<String, Object> synMap) {
        try {
            ...
            String redirectUri = StringUtil.isNotEmpty(dd.getRedirectUri()) ? dd.getRedirectUri() : SystemPropertiesConfig.YDHC_DD_REDIRECTURI;
            ...
            logger.error("getLoginParam 请求异常",e);
        }
        return JsonUtil.gsonStr(synMap);
    }
    ...
    public String doLogin(HttpServletRequest request) {
        try {
            if (StringUtil.isEmpty(request.getParameter("code"))) {
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_404;
            }
            Optional<Dd> optional = Optional.ofNullable(DictionaryUtil.getdingtalkParamByServiceIdentifying(Constants.SERVICEIDENTIFYING)
                    .orElseGet(() -> userService.getDdConfigByServiceIdentifying(Constants.SERVICEIDENTIFYING)));
            Dd dd = optional.get();
            ...
            try {
                ...
                if (null == obj1 || obj1.getInteger("errcode") != 0) {
                    ...
                    return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_405;
                }
            } catch (Exception e) {
                logger.error(LoginEnum.LG_406.getMessage(), e);
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_406;
            }
            ...
            if (null == obj2 || obj2.getInteger("errcode") != 0) {
                ...
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_407;
            }
            ...
            if (null == obj3 || obj3.getInteger("errcode") != 0) {
                ...
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_408;
            }
            ...
            if (null != obj4 && obj4.getInteger("errcode") != 0) {
                ...
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_409;
            }
            ...
            if (null == obj6 || obj6.getInteger("errcode") != 0) {
                ...
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_410;
            }
            ...
            if (null == user || StringUtil.isEmpty(user.getId())) {
                return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_416;
//                user = new User();
...
//                user = userService.getUserByLoginName(loginName);
                ...
                if (CodeConstant.NORMAL_STATUS == user.getStatus()) {
                    ...
                    return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_411;
                }
            }
           ...
           logger.info(token);
            ...
            return SystemPropertiesConfig.YDHC_REDIRECT_URL_SUCCEED + token;
        } catch (DisabledAccountException lae) {
            return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_412;
        } catch (AccountException lae) {
            return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_412;
        } catch (Exception e) {
            logger.error("登陆访问异常", e);
            return SystemPropertiesConfig.YDHC_REDIRECT_URL_FAILURE + ResultConstant.LOGIN_FAILURE_413;
        }
    }
