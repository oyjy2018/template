...
import com.ydc.cgj.rental.web.feignService.RentalSettlementFeignService;
...
public class RentalSettlementServiceImpl implements RentalSettlementService {
    ...
    public Result saveRentalSettlement(RentalSettlementDTO rentalSettlementDTO) {
        ...
        RentalDeposit rentalDeposit = rentalSettlementFeignService.getRentalOrderDeposit(rentalSettlementDTO.getOrderId(),(int)RentalDepositConstant.DEPOSIT_TYPE_1);
        ...
        if(rentalSettlementDTO.getDeductRentCarPreAuthorizationAmount() != null &&
            ...
            return Result.failure("扣除租车预授权额不能租车预授权额");
        }
...
//                && rentalDeposit.getPaymentMode().intValue() != RentalDepositConstant.PAYMENT_MODE_1
     ...
     */
    @Override
    public Result updateAliPaySettleDTO(Integer orderId, Integer type) {
