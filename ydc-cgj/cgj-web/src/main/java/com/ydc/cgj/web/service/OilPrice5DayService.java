...
public interface OilPrice5DayService {
    ...
    Object getToday(@RequestParam(value = "province") String province, @RequestParam(value = "province") String city);

    @RequestMapping(value = "/oil/history", method = RequestMethod.POST)
    Object getHistory(@RequestParam(value = "province") String province, @RequestParam(value = "province") String city);
}
