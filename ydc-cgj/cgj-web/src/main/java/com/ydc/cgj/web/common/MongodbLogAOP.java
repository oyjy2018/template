package com.ydc.cgj.web.common;
...
public class MongodbLogAOP {
    ...
    @Pointcut("execution(public * com.ydc.cgj.web.controller.*.*(..))")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        if (user != null){
            ...
            subject.put("userId",user.getId().toString());
            subject.put("userName",user.getUserName());
            mongoLogMessageVO.setSubject(subject);
            logger.info("userId:{},userName:{}",user.getId().toString(),user.getUserName());
        }
