 ...
 * @date 2019/1/8
 */
public interface CgjButtonConfigService {
    /**
     * 根据主键删除
     * 参数:主键
     * 返回:删除个数
     ...
     * @date: 2019/1/8
     */
    List<Map<String, Object>> queryButtonConfigList(AdvertConfigQueDTO advertConfigQueDTO);
    /**
     * 修改所有是否开启
     * @author: hejiangping
     * @date: 2019/1/8
     */
    int updateSwitchStatus(AdvertConfigQueDTO advertConfigQueDTO);
    /**
     * 移动端查询按钮配置
     * @author: hejiangping
     * @date: 2019/1/8
     */
    List<Map<String, Object>> queryButtonConfigs(String clientDictKey);
    /**
     * 更新按钮到redis缓存
     * @author: hejiangping
     * @date: 2019/1/8
     */
    void putAdvertToRedis();
}
