...
public interface AdvertConfigService {
     ...
     * @date: 2019/1/2
     */
    List<Map<String, Object>> queryAdvertConfigList(AdvertConfigQueDTO advertConfigQueDTO);
    /**
     * 获取广告配置详情
     * @author: hejiangping
     * @date: 2019/1/2
     ...
     * @date: 2019/1/3
     */
    List<Map<String, Object>> queryAdverts(String clientDictKey, String moduleDictKey);
    /**
     * 更新广告到redis缓存
     * @author: hejiangping
     * @date: 2019/1/5
