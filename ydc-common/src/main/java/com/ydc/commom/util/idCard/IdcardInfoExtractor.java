 ...
 *
 * @author gongjin
 * @create 2017-05-08 13:18
 **/
public class IdcardInfoExtractor {
    private static final Logger logger = LogManager.getLogger(IdcardInfoExtractor.class);
    ...
    public IdcardInfoExtractor(String idcard) {
        try {
            ...
            if (validator.isValidatedAllIdcard(idcard)) {
                ...
                if((this.month > nowMonth) || (nowMonth == this.month && this.day >= nowDay )){
                	this.age --;
                }
            }
        } catch (Exception e) {
            logger.error("通过构造方法初始化各个成员属性异常",e);
        }
    }

    public static void main(String[] args) {
    	  String idCard = "420582199109235868";
    	 logger.info(IdcardUtil.getAgeByIdcard(idCard));
	}
    /**
     * @return the province
     */
