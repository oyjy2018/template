...
public class EnterpriseOrderDetailB2BDVO {
    ...
    //保证金
    private BigDecimal actualMargin;    //实付保证金
    private Integer marginPayStatus;    //保证金支付状态
    private String marginPayStatusCH;
    private String marginPaytTime;  //保证金支付时间
    private String marginRefundTime;    //保证金退还时间
    ...
    //租金押金信息
    private BigDecimal payRentTotal;   //租金总额
    private BigDecimal payCashPledge;  //押金
    private String rentPayDate;  //租金与押金支付日期
    ...
    public Integer getMarginPayStatus() {
        return marginPayStatus;
    }

    public void setMarginPayStatus(Integer marginPayStatus) {
        this.marginPayStatus = marginPayStatus;
    }

    public String getMarginPayStatusCH() {
        RentalDepositEnum.PaymentStatus enumObj = RentalDepositEnum.PaymentStatus.getPaymentStatusByStatus(marginPayStatus);
        if(enumObj == null){
            return "";
        }else{
            return enumObj.getStatucCHDemand();
        }
    }

    public void setMarginPayStatusCH(String marginPayStatusCH) {
        this.marginPayStatusCH = marginPayStatusCH;
    }

    public String getMarginPaytTime() {
        return marginPaytTime;
    }

    public void setMarginPaytTime(Date marginPaytTime) {
        this.marginPaytTime = DateUtil.formatDateAndTime(marginPaytTime);
    }

    public String getMarginRefundTime() {
        return marginRefundTime;
    }

    public void setMarginRefundTime(Date marginRefundTime) {
        this.marginRefundTime = DateUtil.formatDateAndTime(marginRefundTime);
    }
    ...
    public BigDecimal getPayRentTotal() {
        return payRentTotal;
    }

    public void setPayRentTotal(BigDecimal payRentTotal) {
        this.payRentTotal = payRentTotal;
    }

    public BigDecimal getPayCashPledge() {
        return payCashPledge;
    }

    public void setPayCashPledge(BigDecimal payCashPledge) {
        this.payCashPledge = payCashPledge;
    }
