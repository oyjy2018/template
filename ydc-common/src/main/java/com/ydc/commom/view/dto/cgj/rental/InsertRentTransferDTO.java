...
/**
 * @author
 * @create 2019-01-08 14:41
 **/
public class InsertRentTransferDTO implements Serializable {
    private static final long serialVersionUID = 393677240712768050L;
     ...
     * 支付凭证文件名
     */
    @Attribute(name = "平台转账凭证名",required = true,emptyStringVerify = true)
    private String payVoucherImgName;

    /**
     * 支付凭证文件路径
     */
    @Attribute(name = "平台转账凭证路径",required = true,emptyStringVerify = true)
