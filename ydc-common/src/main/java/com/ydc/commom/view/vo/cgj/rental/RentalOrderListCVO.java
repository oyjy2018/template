...
public class RentalOrderListCVO {
    ...
    public void setRentalAccreditStatus(Integer rentalAccreditStatus) {
        if(rentalAccreditStatus == null){
            this.rentalAccreditStatus = Integer.valueOf(RentalDepositConstant.PAYMENT_STATUS_1);
        }else{
    ...
    public void setViolationAccreditStatus(Integer violationAccreditStatus) {
        if(violationAccreditStatus == null){
            this.violationAccreditStatus = Integer.valueOf(RentalDepositConstant.PAYMENT_STATUS_1);
        }
